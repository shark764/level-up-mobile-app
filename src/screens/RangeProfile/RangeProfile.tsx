        ...
        <View style={styles.headerContainer}>
          <ImageBackground source={homeBackground} style={stylesx.image}>
            <View style={{ height: '100%' }}>
              <View
                style={{ flexDirection: 'row', marginLeft: 15, marginTop: 25 }}>
              ...
              <View
                ...
                <View
                  ...
                  <View>
                    <Text type='heading-6' style={{ color: '#9BB1D2' }}>
                      {' '}
                      PHOTOS
                    </Text>
                  </View>
        ...
        <View style={{ flexDirection: 'column', backgroundColor: '#24263F' }}>
          <View style={styles.bodyHeaderContainer}>
            <View style={{ flexDirection: 'row', marginBottom: 25 }}>
              ...
              <View style={{ marginRight: 15 }}>
                <View style={{ flexDirection: 'column' }}>
                  <View>
                    <Text type='heading-2' style={{ color: 'white' }}>
                      CA Fire
                    </Text>
                  </View>
                  <View>
                    <Text type='body' style={styles.members}>
                      467 Members
                    </Text>
                  </View>
                </View>
            ...
            <View>
              <Text
                type='body-sm'
                style={{ color: '#9BB1D2', textAlign: 'justify' }}>
                Facility description nullam enim odio, porttitor eget enim eget,
                lacinia sollicitudin ipsum. Phasellus quis ante in lacus
                bibendum aliquam.
              </Text>
            </View>
          </View>
          <View style={styles.subBodyContainer}>
            ...
            <View
              ...
              <View style={{ width: '85%' }}>
                <Text type='body' style={{ color: '#9BB1D2' }}>
                  2715 Ash Dr. San Jose, South Dakota 834475, United States
                </Text>
              </View>
            </View>
            <View
