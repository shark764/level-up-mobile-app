    ...
    <View style={props.viewStyle}>
      ...
      <View style={props.textDivider}>
        <View
          style={{
            flex: 1,
            height: 1,
            backgroundColor: props.colDivider,
            marginTop: '4.5%'
          }}
        />
        <View style={{ width: '50%' }}>
      ...
      <View style={props.socialMedia}>
        <TouchableHighlight
          ...
          <Image style={props.socialMediaLogo} source={logo_fb} />
        </TouchableHighlight>
        ...
        <TouchableHighlight
          ...
          underlayColor='transparent'>
          <Image style={props.socialMediaLogo} source={logo_google} />
        </TouchableHighlight>
      ...
      <TouchableHighlight
        ...
        <Text type='body' style={props.mainFooter}>
          Don't have an account?{' '}
          <Text type='body' style={props.subFooter}>
            Sign Up
          </Text>
        </Text>
      </TouchableHighlight>
