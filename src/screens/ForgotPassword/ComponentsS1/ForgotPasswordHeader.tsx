...
const forgotPasswordHeader = (props: Props) => {
    return (
        <><View style={props.viewStyle}>
          ...
          <View style={props.viewStyle}>
            <Text style={props.textSubHeader}>Enter your registered email and we will</Text>
            <Text style={props.textSubHeader}>get back to you with the reset password</Text>
