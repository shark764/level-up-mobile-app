        ...
        <Container background='dark'>
            <ScrollView>
                ...
                <View>
                    ...
                    <Text type='heading-5' style={styles.subHeaderText}>AT VERO EOS ET ACCUSAMUS ET IUSTO ODIO DIGNISSIMOS DUCIMUS QUI BLANDITIIS</Text>
                    ...
                    <View style={[styles.flexRow, { marginTop: 30 }]}>
                        <View style={{ marginRight: 10 }}>
                            <CheckBox tintColors={{ true: '#6461EC', false: '' }}
                                ...
                                onValueChange={(checkValue) => { setToggleCheckBox(checkValue) }}
                            />
                        </View>
                        <View>
                            <Text type='body-md' style={styles.bodyText}>I read and accept the terms</Text>
                        </View>
                    </View>
                    <View>
